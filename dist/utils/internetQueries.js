...
export async function tavilyQuery(query, ak, depth) {
    try {
...
export async function jinaQuery(query, ak) {
    try {
...
export async function braveQuery(query, ak) {
    try {
...
export async function exaQuery(query, ak) {
 ...
 */
export async function duckduckgoQuery(query) {
    try {
        ...
        const finalResults = ddgResults.results.slice(0, 5).map((result) => {
