...
const PdfSectionContentSchema = z.object({
    content: z.array(z.discriminatedUnion("elementType", [
        z.object({
...
// --------------------------------------------------------------------
function addHeading(doc, params, defaultColor) {
...
function addParagraph(doc, params, defaultColor) {
...
// --------------------------------------------------------------------
export async function runPdfGenAgent(request) {
  ...
  "content": [
    ...
    `;
        const sectionConversation = [
            { role: "system", content: "You are an expert content generator for documents." },
