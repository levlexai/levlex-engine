...
router.post("/call", async (req, res) => {
    ...
    try {
        ...
        return respondWithTwiML(res, hangupResponse("An error occurred generating the next question. Goodbye."));
    }
    ...
    try {
        ...
        return respondWithTwiML(res, gatherTwiML("An error occurred generating audio. Please enter digits."));
    }
