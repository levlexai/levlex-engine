...
export async function runCodeAgent(request) {
    const { prompt, model, max_recursion = 10, language = "javascript", } = request;
    // We'll store each code snippet and output in this array
    const ranCodeArray = [];
    // The loop function
    async function codeIteration(currentPrompt, recursionCount) {
